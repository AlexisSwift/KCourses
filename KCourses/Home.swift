...
let menuData = [
   Menu(title: "Мой Аккаунт", icon: "person.crop.circle"),
   Menu(title: "Настройки", icon: "gear"),
   Menu(title: "Покупки", icon: "creditcard"),
   Menu(title: "Команда", icon: "person.2"),
   Menu(title: "Выйти", icon: "arrow.uturn.down")
]
